...
<c:if test="${userinfo.userRole == 'ADMIN_ROLE' || userinfo.userRole == 'CUSTOMER_ROLE'}">
...
<c:forEach items="${posts}" var="p">
    <div class="bg-white p-4 rounded shadow mt-3" id="post${p.id}" style="width: 70%">
        ...
        <div class="d-flex justify-content-between">
            ...
            <c:if test="${p.customerId.userId.id == userinfo.id}">
        ...
        <div class="mt-3" >
            ...
            <c:choose>
                <c:when test="${userinfo.userRole == 'SHIPPER_ROLE'}">
                    <div class="post__comment mt-3 position-relative" id="auction${p.id}">
                        <!-- Auction start-->
                                ...
                                <div id="collapsePost1" class="accordion-collapse collapse"
                                    ...
                                    <div class="accordion-body">
                                        <c:forEach items="${auctions}" var="a">
                                            <c:if test="${a.postId.id == p.id && a.shipperId.userId.id == userinfo.id}">
                                                    ...
                                                    <div class="p-3 rounded comment__input w-100">
                                                        ...
                                                        <div class="d-flex justify-content-end">
                                                            ...
                                                            <ul class="dropdown-menu border-0 shadow"
                                                                ...
                                                                <c:url value="/api/posts/${a.id}/auctions" var="endpoint2" />
                                                                <li class="d-flex align-items-center">
                                                                    <input onclick="deleteAuction('${endpoint2}')" type="button" class="dropdown-item d-flex
                                        ...
                                        <!-- create Auction -->
                                        <c:if test="${userinfo.userRole == 'SHIPPER_ROLE'}">
                                            <div class="d-flex my-1">
                                                ...
                                                <c:url value="/api/posts/${p.id}/auctions" var="endpoint1" />
                                                <!-- input -->
                                                <input id="content${p.id}" type="text" class="form-control" placeholder="Nhập nội dung"/>
                                                <input id="price${p.id}" type="text" class="form-control ms-2" placeholder="Nhập giá"/>
                                                <input type="button" onclick="addAuction('${endpoint1}', ${p.id})" value="Đấu giá" class="btn btn-outline-secondary ms-2" />
                                            </div>
                                        </c:if>
                                        <!-- end -->
                                    </div>
                                                        ...
                                                        <div class="p-3 rounded comment__input w-100">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-8">
                                                                    ...
                                                                    <p class="email${a.id}" value="${a.shipperId.userId.email}">${a.shipperId.userId.email}</p>
                                                                    <p class="card-text"><small className="text-muted">${a.createdDate}</small></p>
                                                                </div>
                                                                <c:if test="${userinfo.userRole == 'CUSTOMER_ROLE'}">
                                                                    <c:url value="/api/order" var="endpoint3" />
                                                                    <div class="col-4 justify-content-md-end btnEmail">
                                                                        <button class="btn btn-primary" onclick="addOrder('${endpoint3}', ${a.id}, ${a.shipperId.id}, ${p.id})" type="button">Chap Nhan</button>
                                                                    </div>
                                                                </c:if>
                                                            </div>
